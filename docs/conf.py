...
s3_bucket = "virtual_dataframe".replace('_','-')
# For git clone ...
git_url = _git_url()
# Project home
...
htmlhelp_basename = 'virtual_dataframedoc'
...
latex_documents = [
    (
        master_doc,  # Doc name
        'virtualdataframe.tex',  # targetname
        'Virtual Dataframe Documentation',  # title
        'Philippe PRADOS',  # author
...
man_pages = [
    ('index',
     'virtual_dataframe',
     'Virtual Dataframe Documentation',
     ['Philippe PRADOS'], 1)
]
